<!-- FUnctions which are necessary for creating, using or destroy a SESSION-->
<?php ob_start();?>
...
<?php
    ...
    // it does not exist an SESSION, redirect to index.php
    if(!isset($_SESSION["usuario"]))
    {
        // ../ => Because the file admin_header is called from index.php of the admin
